"""
Django settings for PythonSirpWeb project.
...
SECRET_KEY = 'django-insecure-7+1ft_nmw8q6$p_x4ia@=*lhbj4$e2!!p+wgt5(iqca4(ifarr'
...
ROOT_URLCONF = 'PythonSirpWeb.urls'
...
WSGI_APPLICATION = 'PythonSirpWeb.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # si tienes carpeta estática global
]
